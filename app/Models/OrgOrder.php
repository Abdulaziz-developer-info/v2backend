...
class OrgOrder extends Model
{
    ...
    protected $fillable = [
            ...
            'given_amount', // mijoz tulagan summa.
            
            // Vaqt ko'rsatkichlari
            'completed_at', // To'lov to'liq amalga oshirilgan aniq vaqt
            'deleted_product', // O'chirilgan mahsulotlar soni (mahsulotlar uchun) 
            'warehouse', // omborda hisob kitob uchun 
    ];
}
