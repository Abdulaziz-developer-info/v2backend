<div class="settings">
    <a href="#" class="btn btn-floating btn-icon btn-primary" data-bs-toggle="offcanvas"
        ...
        <i class="ti ti-brush" style="font-size: 20px; color: #d7d7d7;"></i>
    </a>
        ...
        <div class="offcanvas-body d-flex flex-column">
            ...
            <div class="mt-auto space-y">
                <button type="button" class="btn w-100" id="reset-changes">
                    <i class="ti ti-rotate" style="font-size: 20px; color: #7d8491;"></i>
                    Reset changes
                </button>
                <a href="#" class="btn btn-primary w-100" data-bs-dismiss="offcanvas">
                    <i class="ti ti-settings" style="font-size: 20px; color: #7d8491;"></i>
                    Save settings
                </a>
            </div>
        </div>
